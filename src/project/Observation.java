...
class Observation {
    ...
    public String toString() {
        ...
        return String.format(Locale.US, "%.6f;%.6f;%.6f;%.6f;%.6f;%.6f;%d\n", gunToTurn, distance, angle, enemyDx, enemyDy, enemyHeading, (bullet.getVictim() == null) ? 0 : 1);
    }
    ...
    private void normalize() {
        this.x = (this.x - 400) / 800;
        this.y = (this.y - 300) / 600;
        this.distance /= 1000;
